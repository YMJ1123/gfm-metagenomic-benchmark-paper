...
\begin{itemize}\setlength{\itemsep}{2pt}
  ...
  \item \textbf{Evaluation level} --- every model scored at the read level and,
        ...
        \citep{Wood2019}.
\end{itemize}
Because the axes are varied independently, the resulting deltas are causal with
respect to each factor rather than confounded by simultaneous changes in model
size, data, and tokenizer. Full hyperparameters, LoRA configuration, and
training commands are given in the Supplementary Material.

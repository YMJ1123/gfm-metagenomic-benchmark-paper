...
the classifier held fixed---a parameter-free multinomial $k$-mer naive Bayes---or
...
6-mer versus $+13$ pp on 13-mer). The parameter-free 13-mer naive Bayes (74.9\%)
...
signal. Most strikingly, the parameter-free 13-mer naive Bayes (74.9\%) still

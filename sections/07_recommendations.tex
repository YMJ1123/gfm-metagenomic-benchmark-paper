...
A 67\%-accurate model is often sufficient ($r=0.99$) and can beat \emph{raw}
Kraken\,2 counts by avoiding abstention bias---but compare against
Kraken\,2$+$Bracken and validate for systematic bias on your community. \\[2pt]
...
\item \textbf{Community abundance?} An always-labelling neural model can help,
but calibrate a detection threshold and check for systematic bias; benchmark
against Bracken.

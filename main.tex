...
a 67\%-accurate read classifier attains Pearson $r=0.99$ for genus abundance and
exceeds raw Kraken\,2 abundance estimates in our coverage-matched evaluation
($r=0.82$; Kraken\,2's $\sim$30\% abstention deflates predicted abundances),
although Kraken\,2 remains far stronger for low-abundance detection and
abundance-corrected pipelines (e.g.\ Bracken) are an important further baseline.

...
comparison with Kraken\,2 that yields concrete, use-case-specific
recommendations---including the non-obvious result that a mid-accuracy neural
model can exceed \emph{raw} Kraken\,2 abundance estimates while remaining a weak
detector. The manuscript is written to help readers decide whether to fine-tune
